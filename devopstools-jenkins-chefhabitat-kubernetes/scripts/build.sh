...
sudo wget -O /scripts/mongodb_acrimage.sh https://raw.githubusercontent.com/fathym-it/azure-quickstart-templates/master/devopstools-jenkins-chefhabitat-kubernetes/scripts/mongodb_acrimage.sh
chmod +x /scripts/mongodb_acrimage.sh
sudo wget -O /scripts/np_acrimage.sh https://raw.githubusercontent.com/fathym-it/azure-quickstart-templates/master/devopstools-jenkins-chefhabitat-kubernetes/scripts/np_acrimage.sh
