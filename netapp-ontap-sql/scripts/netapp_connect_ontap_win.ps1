...
$WebClient.DownloadFile("https://raw.githubusercontent.com/fathym-it/azure-quickstart-templates/master/netapp-ontap-sql/scripts/NetApp_PowerShell_Toolkit_4.3.0.msi","C:\NetApp\NetApp_PowerShell_Toolkit_4.3.0.msi")
